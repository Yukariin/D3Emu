...
void InitDefaultsBGSMethodOptions() {
  ...
  ::google::protobuf::GoogleOnceInit(&once, &InitDefaultsBGSMethodOptionsImpl);
}
...
void protobuf_AssignDescriptors() {
  ...
  AssignDescriptors(
      "method_options.proto", schemas, file_default_instances, TableStruct::offsets, factory,
...
void AddDescriptorsImpl() {
  ...
  static const char descriptor[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
      "\n\024method_options.proto\022\014bgs.protocol\032 go"
      "ogle/protobuf/descriptor.proto\"\036\n\020BGSMet"
      "hodOptions\022\n\n\002id\030\001 \001(\r:X\n\016method_options"
      "\022\036.google.protobuf.MethodOptions\030\220\277\005 \001(\013"
      "2\036.bgs.protocol.BGSMethodOptionsB%\n\rbnet"
      ".protocolB\022MethodOptionsProtoH\002"
  };
...
BGSMethodOptions::BGSMethodOptions()
  ...
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    ::protobuf_method_5foptions_2eproto::InitDefaultsBGSMethodOptions();
  }
  SharedCtor();
...
const ::google::protobuf::Descriptor* BGSMethodOptions::descriptor() {
  ::protobuf_method_5foptions_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_method_5foptions_2eproto::file_level_metadata[kIndexInFileMessages].descriptor;
}
...
BGSMethodOptions* BGSMethodOptions::New(::google::protobuf::Arena* arena) const {
  BGSMethodOptions* n = new BGSMethodOptions;
  if (arena != NULL) {
    arena->Own(n);
  }
  return n;
...
::google::protobuf::Metadata BGSMethodOptions::GetMetadata() const {
  protobuf_method_5foptions_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_method_5foptions_2eproto::file_level_metadata[kIndexInFileMessages];
}

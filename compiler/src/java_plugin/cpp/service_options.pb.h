...
inline void InitDefaults() {
  InitDefaultsBGSServiceOptions();
  InitDefaultsSDKServiceOptions();
}
}  // namespace protobuf_service_5foptions_2eproto
namespace bgs {
namespace protocol {
...
class BGSServiceOptions : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:bgs.protocol.BGSServiceOptions) */ {
 public:
  ...
  inline BGSServiceOptions* New() const PROTOBUF_FINAL { return New(NULL); }

  BGSServiceOptions* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
 ...
 private:
  ...
  friend struct ::protobuf_service_5foptions_2eproto::TableStruct;
  friend void ::protobuf_service_5foptions_2eproto::InitDefaultsBGSServiceOptionsImpl();
};
// -------------------------------------------------------------------
...
class SDKServiceOptions : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:bgs.protocol.SDKServiceOptions) */ {
 public:
  ...
  inline SDKServiceOptions* New() const PROTOBUF_FINAL { return New(NULL); }

  SDKServiceOptions* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  int GetCachedSize() const PROTOBUF_FINAL { return _cached_size_; }
  private:
  void SharedCtor();
  void SharedDtor();
 ...
 private:
  ...
  bool outbound_;
  friend struct ::protobuf_service_5foptions_2eproto::TableStruct;
  friend void ::protobuf_service_5foptions_2eproto::InitDefaultsSDKServiceOptionsImpl();
};
// ===================================================================
